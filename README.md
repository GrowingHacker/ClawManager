...
[![Version](https://img.shields.io/badge/version-v1.0-cyan?style=flat-square)](https://github.com)
...
```bash
# Fork 本仓库后克隆到本地
git clone https://github.com/your-username/ClawManager.git
